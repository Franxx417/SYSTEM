...
<?php $__env->startSection('page_subheading','System administration and oversight'); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0"><?php echo e($metrics['users'] ?? 0); ?></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0"><?php echo e($metrics['active_sessions'] ?? 0); ?></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0"><?php echo e($metrics['db_size'] ?? 'N/A'); ?></div>
                    </div>
...
<div class="tab-content">
    <?php echo $__env->make('superadmin.tabs.' . $tabFile, ['active' => $active], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addUserForm" method="POST" action="<?php echo e(route('superadmin.users.create')); ?>">
                <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/dashboards/superadmin-dashboard-enhanced.js', 'resources/css/pages/superadmin-dashboard.css']); ?>
    <script>
    // Show Add User Modal
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KAIZER\Desktop\cdn\resources\views/dashboards/superadmin.blade.php ENDPATH**/ ?>