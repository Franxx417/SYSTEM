            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $usersList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="user-row">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-2">
                                                <?php echo e(strtoupper(substr($user->name ?? $user->username ?? 'U', 0, 1))); ?>

                                            </div>
                                            <div>
                                                <div class="fw-medium user-name"><?php echo e($user->name ?? $user->username); ?></div>
                                                <div class="text-muted small user-email"><?php echo e($user->email ?? 'No email'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge bg-secondary user-role"><?php echo e($user->display_role ?? ($user->role ?? 'Unknown')); ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-muted small"><?php echo e($user->last_login ?? ($user->updated_at ?? 'Never')); ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-outline-warning" 
                                                    data-action="reset-password" 
                                                    data-user-id="<?php echo e($user->user_id ?? $user->id); ?>">
                                                <i class="fas fa-key me-1"></i>Reset
                                            </button>
                                            <button class="btn btn-outline-danger" 
                                                    data-action="toggle-user" 
                                                    data-user-id="<?php echo e($user->user_id ?? $user->id); ?>">
                                                <i class="fas fa-<?php echo e(($user->is_active ?? true) ? 'ban' : 'check'); ?> me-1"></i>
    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $displayStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH C:\Users\KAIZER\Desktop\cdn\resources\views/superadmin/tabs/users.blade.php ENDPATH**/ ?>