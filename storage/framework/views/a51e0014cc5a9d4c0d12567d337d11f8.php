...
<?php $__env->startSection('page_heading','Suppliers'); ?>
<?php $__env->startSection('page_subheading','Manage suppliers'); ?>
<?php $__env->startSection('content'); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($s->vat_type ?? '—'); ?></td>
                        <td><?php echo e($s->contact_person); ?> <?php echo e($s->contact_number ? ' - '.$s->contact_number : ''); ?></td>
                        <td class="text-end">
                            <div class="btn-group btn-group-sm" role="group">
                                <button class="btn btn-outline-primary" onclick="editSupplier('<?php echo e($s->supplier_id); ?>', '<?php echo e(addslashes($s->name)); ?>', '<?php echo e($s->vat_type); ?>', '<?php echo e(addslashes($s->address ?? '')); ?>', '<?php echo e(addslashes($s->contact_person ?? '')); ?>', '<?php echo e($s->contact_number ?? ''); ?>', '<?php echo e($s->tin_no ?? ''); ?>')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                    </svg>
                                </button>
                                <button class="btn btn-outline-danger" onclick="deleteSupplier('<?php echo e($s->supplier_id); ?>', '<?php echo e(addslashes($s->name)); ?>')">
    ...
    <div class="mt-2"><?php echo e($suppliers->links()); ?></div>
    ...
    <div class="modal fade" id="addSupplierModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="addSupplierForm" method="POST" action="<?php echo e(route('suppliers.store')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/suppliers-index.js']); ?>
<?php $__env->stopSection(); ?>




<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KAIZER\Desktop\cdn\resources\views/suppliers/index.blade.php ENDPATH**/ ?>