<?php $__env->startSection('title','My Purchase Orders'); ?>
<?php $__env->startSection('page_heading','My Purchase Orders'); ?>
<?php $__env->startSection('page_subheading','Create and track your purchase orders'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-3">
        <div class="col-lg-8 mb-3 mb-lg-0">
            <form method="GET" action="<?php echo e(route('po.index')); ?>" class="row g-2">
                <div class="col-md-4 col-sm-6 mb-2 mb-sm-0">
                    <input type="text" name="search" class="form-control" placeholder="Search by PO number or purpose..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-md-3 col-sm-6 mb-2 mb-sm-0">
                    <select name="status" class="form-select">
                        <option value="">All Statuses</option>
                        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status->status_id); ?>" <?php echo e(request('status') == $status->status_id ? 'selected' : ''); ?>>
                ...
                <div class="col-md-3 col-sm-6 mb-2 mb-sm-0">
                    <select name="supplier" class="form-select">
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($supplier->supplier_id); ?>" <?php echo e(request('supplier') == $supplier->supplier_id ? 'selected' : ''); ?>>
  ...
  <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.128.334L10 8.692V13.5a.5.5 0 0 1-.342.474l-3 1A.5.5 0 0 1 6 14.5V8.692L1.628 3.834A.5.5 0 0 1 1.5 3.5zm1 .5v1.308l4.372 4.858A.5.5 0 0 1 7 8.5v5.306l2-.666V8.5a.5.5 0 0 1 .128-.334L13.5 3.308V2z"/>
        ...
        <div class="col-lg-4 text-sm-end">
            <div class="d-flex gap-2 justify-content-end">
                 <a class="btn btn-outline-primary" href="<?php echo e(route('po.create')); ?>?new=1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                <?php $__currentLoopData = $pos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $po): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($po->purchase_order_no); ?></td>
                        <td><?php echo e(Str::limit($po->purpose, 30)); ?></td>
                        <td><?php echo e(Str::limit($po->supplier_name ?? '—', 20)); ?></td>
                        <td>
                            <?php
                            ...
                            <div style="cursor: pointer;" 
                                 data-po="<?php echo e($po->purchase_order_no); ?>" 
                                 data-current-status="<?php echo e($statusName); ?>"
                                 onclick="showStatusChangeModal('<?php echo e($po->purchase_order_no); ?>', '<?php echo e($statusName); ?>')">
                                <?php echo $__env->make('partials.status-display', ['status' => $statusName, 'type' => 'text'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </td>
                        <td class="text-end">₱<?php echo e(number_format($po->total, 2)); ?></td>
                        <td class="text-center">
                            <div class="btn-group btn-group-md" role="group">
                                <button class="btn btn-outline-primary btn-view-po" data-po="<?php echo e($po->purchase_order_no); ?>" title="View Details">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
  <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z"/>
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"/>
</svg>                                </button>
                                <button class="btn btn-outline-warning" onclick="showEditModal('<?php echo e($po->purchase_order_no); ?>')" title="Edit">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
</svg>                                </button>
                                <button class="btn btn-outline-danger" onclick="deletePO('<?php echo e($po->purchase_order_no); ?>', '<?php echo e(addslashes($po->purpose)); ?>')" title="Delete">
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
                                ...
                                <button class="btn btn-outline-info btn-print-direct" 
                                        data-po-number="<?php echo e($po->purchase_order_no); ?>"
                                        data-fallback-url="<?php echo e(route('po.print', $po->purchase_order_no)); ?>"
                                        title="Print (Direct)" 
                                        aria-label="Print Purchase Order <?php echo e($po->purchase_order_no); ?>">
...
<div class="mt-3 d-flex justify-content-center"><?php echo e($pos->links()); ?></div>
    ...
    <div class="modal fade" id="editPOModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="poEditForm" method="POST" data-latest-price-url="<?php echo e(route('api.items.latest_price')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select item-name-select" name="items[IDX][item_name]">
                            ...
                            <?php $__currentLoopData = $existingNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($row->item_name); ?>" data-desc="<?php echo e($row->sample_desc); ?>" data-price="<?php echo e($row->unit_price); ?>"><?php echo e($row->item_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                            ...
                            <div class="list-group">
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="list-group-item list-group-item-action status-option" 
                                         data-status-id="<?php echo e($status->status_id); ?>" 
                                         data-status-name="<?php echo e($status->status_name); ?>"
                                         onclick="selectStatus(this)"
                                         style="cursor: pointer;">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h6 class="mb-1"><?php echo e($status->status_name); ?></h6>
                                        </div>
                                        <p class="mb-0 text-muted small"><?php echo e($description); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/po-index.js', 'resources/js/pages/po-edit.js']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KAIZER\Desktop\cdn\resources\views/po/index.blade.php ENDPATH**/ ?>