...
<?php $__env->startSection('page_heading','Items Management'); ?>
<?php $__env->startSection('page_subheading','Manage your item catalog'); ?>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('items.inventory')); ?>" class="btn btn-outline-secondary">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <form method="GET" action="<?php echo e(route('items.index')); ?>" class="d-flex">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                        ...
                        <?php if($search): ?>
                            <a href="<?php echo e(route('items.index')); ?>" class="btn btn-outline-danger ms-2">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <strong><?php echo e($item->item_name ?: Str::limit($item->item_description, 50) ?: 'N/A'); ?></strong>
                                    <?php if($item->item_description): ?>
                                        <div class="small text-muted"><?php echo e(Str::limit($item->item_description, 50)); ?></div>
                                    <?php endif; ?>
                                </td>
                                
                                <td class="text-center">₱<?php echo e(number_format($item->unit_price, 2)); ?></td>
                                <td class="text-center">₱<?php echo e(number_format($item->total_cost, 2)); ?></td>
                                <td><?php echo e($item->supplier_name ?: 'N/A'); ?></td>
                                <td><?php echo e($item->created_at ? \Carbon\Carbon::parse($item->created_at)->format('M d, Y') : 'N/A'); ?></td>
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <button class="btn btn-outline-primary" title="Edit" 
                                onclick="editItem('<?php echo e($item->item_id); ?>', '<?php echo e(addslashes($item->item_name ?: $item->item_description)); ?>', '<?php echo e(addslashes($item->item_description)); ?>', '<?php echo e($item->quantity); ?>', '<?php echo e($item->unit_price); ?>')">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                        ...
                                        <button type="button" class="btn btn-outline-danger" 
                                                onclick="confirmDelete('<?php echo e($item->item_id); ?>', '<?php echo e($item->item_name ?: $item->item_description); ?>')" 
                                                title="Delete">
  ...
  <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
    ...
    <div class="modal fade" id="createItemModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('items.store')); ?>" id="createItemForm">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <?php if($errors->any()): ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="create_item_name" name="item_name" 
                                       value="<?php echo e(old('item_name')); ?>" required maxlength="255" placeholder="Enter item name">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="create_quantity" name="quantity" 
                                       value="<?php echo e(old('quantity', 1)); ?>" required min="1" placeholder="Enter quantity">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="create_item_description" name="item_description" 
                                          ...
                                          placeholder="Enter detailed description of the item"><?php echo e(old('item_description')); ?></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="create_unit_price" name="unit_price" 
                                           value="<?php echo e(old('unit_price')); ?>" required min="0" step="0.01" placeholder="0.00">
                                </div>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/items-index.js']); ?>
<?php $__env->stopSection(); ?>




<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\KAIZER\Desktop\cdn\resources\views/items/index.blade.php ENDPATH**/ ?>