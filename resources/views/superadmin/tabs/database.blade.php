    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="text-center p-3 bg-light rounded">
                            <div class="h4 text-primary mb-1" data-db-stat="total_tables">
                                {{ isset($dbStats['total_tables']) && is_numeric($dbStats['total_tables']) ? number_format($dbStats['total_tables']) : '0' }}
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="text-center p-3 bg-light rounded">
                            <div class="h4 text-info mb-1" data-db-stat="total_records">
                                {{ isset($dbStats['total_records']) && is_numeric($dbStats['total_records']) ? number_format($dbStats['total_records']) : '0' }}
                            </div>
                ...
                @if(!isset($dbStats) || empty($dbStats))
                ...
                <div class="d-flex gap-2 mb-3">
                    ...
                    <a href="{{ route('superadmin.database') }}" class="btn btn-primary" title="Configure database settings">
