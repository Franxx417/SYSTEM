        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <span class="text-muted" data-system-info="php_version">{{ PHP_VERSION }}</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Laravel Version</span>
                    <span class="text-muted" data-system-info="laravel_version">{{ app()->version() }}</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Server Time</span>
                    <span class="text-muted" data-system-info="server_time">{{ now()->format('Y-m-d H:i:s') }}</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Uptime</span>
                    <span class="text-muted" data-system-info="uptime">{{ $systemInfo['uptime'] ?? 'N/A' }}</span>
                </div>
                <hr>
