...
@section('page_heading','All Purchase Orders')
@section('page_subheading','View and track all purchase orders')
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                $statusName = $currentStatus ? $currentStatus->status_name : ($po->status_name ?? 'Unknown');
                                $canWrite = (($auth['role'] ?? null) === 'superadmin') || ((string)($po->requestor_id ?? '') === (string)($auth['user_id'] ?? ''));
                            @endphp
