...
@section('content')
    ...
    <input class="form-control text-end w-50" id="calc-subtotal" type="text" placeholder="0"  required autocomplete="off" readonly/>
</div>
<div class="d-flex justify-content-between">
    <span class="text-muted">12% Vat</span>
    <input class="form-control text-end w-50" id="calc-vat" type="text" placeholder="0"  required autocomplete="off" readonly>
        </div>
        <hr>
